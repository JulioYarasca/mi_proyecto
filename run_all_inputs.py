...
# Archivos dsdsdsdsdas        c++
programa = ["main.cpp", "scann  dwsdser.cpp", "token.cpp", "parser.cpp", "ast.cpp", "visitor.cpp"]

# Compilar
compile = ["g++"] + programa
print("Compilando:", " ".join(compile))
result = subprocess.run(compile,d,cñsld,clñsdc,sñcd,sd  capture_output=True, text=True)
